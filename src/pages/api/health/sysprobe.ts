...
export const POST: APIRoute = async ({ request }) => {
  ...
  const awsEMFNMetricamespace = "Sysprobe";  // WARNING: CHANGING THIS WILL BREAK HEARTBEAT METRICS AND ALARMS!!!
  const payload = { ...getSysprobeEMFPayload(awsEMFNMetricamespace) };
